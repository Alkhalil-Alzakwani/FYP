...
Comprehensive real-time threat monitoring dashboard with live log ingestion:
    • Fetch logs from Splunk API (10.120.254.7:8000) with 30-day history
...
9. FOOTER
    └─ Connection info: Splunk API endpoint (10.120.254.7:8000)

════════════════════════════════════════════════════════════════════════════
 SPLUNK INTEGRATION
════════════════════════════════════════════════════════════════════════════
• API endpoint: 10.120.254.7:8000
...
st.markdown(
    ...
    <p>Live Threat Monitor - Connected to Splunk at 10.120.254.7:8000</p>
    </div>
    """,
    unsafe_allow_html=True
)